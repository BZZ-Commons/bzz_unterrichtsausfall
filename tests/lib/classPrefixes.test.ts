...
import { matchesAllowedPrefix, prefixRank, compareClassPriority, PREFIX_ORDER } from '@/src/lib/classPrefixes';

describe('matchesAllowedPrefix', () => {
  it('accepts real class prefixes', () => {
    for (const name of ['IA24 a', 'IM23 b', 'KVA24 c', 'KVE25 d', 'ME24 c', 'FBA23 a', 'FBM24 a', 'AB24 c', 'BM24 a']) {
  ...
  it('rejects Förderkurse, Freifächer and Lernfoyer', () => {
    ...
    for (const name of ['FKBM2', 'FKBM23', 'FKDE', 'FKKVE23', 'FKSP', 'FFEN', 'LFH a', 'LFS a (UserId:5)']) {
